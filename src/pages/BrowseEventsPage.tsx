        ...
        <div className="browse-events-container">
            ...
            <div className="events-container position-relative">
                <div className="events-list">
                    {events.map(event => (
                        <div className="event-card">
                            <div key={event.id} className="event-content" onClick={() => handleEventClick(event.id)}>
                ...
                <div className="map-container">
                    <button>Map should be here</button>
                </div>
        ...
        {selectedEvent && (
          <Container>
            <Row className="mb-3">
              ...
              { /* todo: links should be added for social media sharing */}
                <FaFacebook size={30} className="mx-2" />
                <FaFacebookMessenger size={30} className="mx-2" />
